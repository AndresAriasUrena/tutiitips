    ...
    <div className='h-auto'>
      <div className='md:flex md:flex-row-reverse mx-auto md:items-center'>
        <div className='min-h-[45vh] md:z-10 md:min-h-0 md:w-full'>
          <div className='relative z-10 top-16 md:static w-[90%] text-primary bg-pink-gr md:bg-secondary drop-shadow-md p-4 md:p-6 rounded'>
        ...
        <div className='min-h-[50vh] md:min-h-0 md:w-[100vw] flex justify-end'>
          <img 
            src={tulsi} 
            alt='Tulsi Bailando'
