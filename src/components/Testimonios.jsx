        ...
        <div className='w-full h-full backdrop-blur-sm bg-black/30 flex'>
          <div className='flex p-4 gap-4 items-center justify-center mx-auto'>
            ...
            <div className='text-white w-full flex flex-col gap-4 md:hidden'>
              <div>
                <p>'Si logras entretejer las primaveras, junto a mis otoños tendremos cubierto el invierno y destilaremos olor, a un eterno verano.'</p>
                <h4>Tulsi Díaz</h4>
              </div>
              <a href='https://forms.gle/2fZrD566M51RYFNv8' target="_blank" onClick={()=>{setActive(''), setToggle(!toggle) }} className='bg-verdeclaro py-2 px-6 w-max rounded-full hover:bg-primary text-white hover:text-secondary mx-auto'>Comprar libro</a>
            </div>
            <div className='text-white text-center w-full md:flex flex-col gap-4 hidden'>
              <div className='font-medium md:text-xl max-w-[794px] mx-auto'>          
                <p>Cuando las emociones inundan mi razón, acudo a la poesía para plasmar mi fantasía.<br/>
                  Abril es desnudar mis sentimientos y entregárselos al mundo, Abril es morir y resucitar entre mis letras, Abril es florecer y marchitarme…<br/>
                  Una y otra vez… <br/>
                  Con amor, Tul.<br/>
                </p>
              </div>
